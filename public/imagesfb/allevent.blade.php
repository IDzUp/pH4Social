                      ...
                      <div class="notif_list">
                         <ul class="event_list">
                            <li>
                                 ...
                                 <button type="button" id="29" name="http://192.169.245.159/~lareval/laravelfb/laravel-master/public/index.php/profileopen/77#post8" class="like_btn pull-right all">Delete</button>
                               </li>
                         </ul>
                     </div>
                 </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="border margin_top">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12">
                         <form enctype="multipart/form-data" id="contactform" accept-charset="UTF-8" action="http://192.169.245.159/~lareval/laravelfb/laravel-master/public/index.php/createevent" method="GET"> <!--contact_request is a router from Route class-->
                ...
                <div class="border margin">
                      <div class="u-event">Upcoming Events </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding2 border-bottom"> <img alt="iamge" class="img-circle img-custom img_wid pull-left" src="../imagesfb/man.jpg">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding2 border-bottom"> <img alt="iamge" class="img-circle img-custom img_wid pull-left" src="../imagesfb/man.jpg">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding2">
                        <a type="submit" class="all_btn" href="http://192.169.245.159/~lareval/laravelfb/laravel-master/public/index.php/allevent">View All</a>
                      </div>
                      <div class="clear"></div>
                </div>
              </div>
