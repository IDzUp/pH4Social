        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li> <i class="fa fa-dashboard"></i> <a href="{{ asset('/index.php') }}/admin">Dashboard</a> </li>
             <li> <i class="fa fa-dashboard"></i> <a href="{{ asset('/index.php') }}/template">Template List</a> </li>
...
@endif
    ...
    <div class="resgister_box">
     <div class="form-group">
         ...
         <input id="name" name="name" placeholder="Name of template" required="" tabindex="1" type="text" class="form-control">
         </div>
