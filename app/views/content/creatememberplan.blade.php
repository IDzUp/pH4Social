...
<script type="text/javascript">
  ...
  <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <i class="fa fa-dashboard"></i> <a href="{{ asset('/index.php') }}/membership">Member List</a> </li>
    ...
    <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Create Membership plan  </h3>
            </div>
      ...
      <div id="f1_card" class="shadow">
        ...
        <div class="member_box">
         <h2> Access admins</h2>
          ...
          <input type="checkbox" id="admin1"  name="removeadmin" class="form-control"/>
        </div>
        </div>
         <div class="back face center">
        <div class="member_box">
         <h2> Access admins</h2>
             <input type="checkbox" id="admin2" name="removeadmin" class="form-control"/>
         </div>
        </div>
      </div>
    </div>
      ...
      <div id="f1_card" class="shadow">
        ...
        <div class="member_box member_box1">
         <h2> Access Super-admins</h2>
           <input type="checkbox" id="super1" name="removesuperadmin"  class="form-control"/>
         </div>
        </div>
         <div class="back face center">
        <div class="member_box member_box1">
         <h2> Access Super-admins</h2>
            <input type="checkbox" id="super2" name="removesuperadmin"  class="form-control"/>
         </div>
        </div>
      </div>
    </div>
      ...
      <div id="f1_card" class="shadow">
        ...
        <div class="member_box member_box2">
         <h2>Access Membership plan</h2>
          <input type="checkbox" id="member1" name="removemember" class="form-control"/>
         </div>
        </div>
         <div class="back face center">
        <div class="member_box">
         <h2> Access Membership plan</h2>
         <input type="checkbox" id="member2" name="removemember" class="form-control"/>
         </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3">
      ...
      <div id="f1_card" class="shadow">
        ...
        <div class="member_box member_box3">
         <h2> Access Users</h2>
       <input type="checkbox" id="user1" name="users" class="form-control"/>
         </div>
        </div>
         <div class="back face center">
        <div class="member_box">
         <h2> Access Users</h2>
       <input type="checkbox" id="user2" name="users" class="form-control"/>
         </div>
        </div>
      </div>
    </div>
