   ...
   <div class="container-fluid">
     ...
     <?php
      ...
      ?>
            ...
            <li> <i class="fa fa-dashboard"></i> <a href="{{ asset('/index.php') }}/creatememberplan">Create Membership Plan</a> </li>
<?php
}
?>
...
<a href="{{ asset('/index.php') }}/deletemem/<?php echo $hello->id ?>"  onclick="return confirm('Are you sure you want to delete?')" class="glyphicon glyphicon-remove"></a>
