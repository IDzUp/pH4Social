...
<form class="form-horizontal" role="form" >
  <div class="form-group">
    <label>{{ Form:: label ('title', 'Title Names*' )}}</label>
     <input type="text" name="title" required="" value="{{ $pageedit->title }}" class="form-control"/>
  </div>
   <div class="form-group">
    <label> {{ Form:: label ('description', 'Description*' )}} </label>
     <input type="text" name="description" required="" value="{{ $pageedit->description }}" class="form-control"/>
  </div>
       <input type="hidden" name="id" value="{{ $pageedit->id }}">
   <div class="form-group">
    <label> {{ Form:: label ('keyword', 'Keyword Name*' )}}  </label>
     <input type="text" name="keyword" required="" value="{{ $pageedit->keyword }}" class="form-control"/>
  </div>
...
tinymce.init({
  ...
  <div class="form-group">
              <label class="checkbox-inline">
                <input type="radio" name="publish" value="yes" <?php if($pageedit->publish=='yes'){ ?>checked="checked" <?php } ?>/>
                Publish </label>
              <label class="checkbox-inline">
                  <input type="radio" name="publish" value="no" <?php if($pageedit->publish=='no'){ ?>checked="checked" <?php } ?>/>
                Unpublish </label>
            </div>
      <div class="form-group">
