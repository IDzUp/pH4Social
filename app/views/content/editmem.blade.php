...
<form class="form-horizontal" role="form" >
  ...
  <div class="form-group">
    <label> {{ Form:: label ('removeadmin', 'Access admins' )}}  </label>
     <input type="checkbox" <?php if($edit->removeadmin=='on'){ ?>checked="" <?php } ?> name="removeadmin" class="form-control"/>
  </div>
 ...
 <div class="form-group">
    <label> {{ Form:: label ('removesuperadmin', 'Access Super-admins' )}}  </label>
     <input type="checkbox" <?php if($edit->removesuperadmin=='on'){ ?>checked="" <?php } ?> name="removesuperadmin"  class="form-control"/>
  </div>

 <div class="form-group">
    <label> {{ Form:: label ('removemember', 'Access Membership plan' )}}  </label>
     <input type="checkbox" <?php if($edit->removemember=='on'){ ?>checked="" <?php } ?> name="removemember" class="form-control"/>
  </div>


 <div class="form-group">
    <label> {{ Form:: label ('users', 'Access Users' )}}  </label>
     <input type="checkbox" <?php if($edit->users=='on'){ ?>checked="" <?php } ?> name="users"  class="form-control"/>
 </div>
