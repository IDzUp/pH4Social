...
<img src="{{ asset('/') }}imagesfb/{{$males}}" width="1170" height="334" alt=""  class="img-rounded"/>
<?php
}
...
$('#comment{{$hello->id}}').val('');
        ...
        <div class="message_box" id="post{{$hello->id}}">
          ...
          <div class="u-nformation"><img  alt="iamge" class="img-circle img_wid" src="{{ asset('') }}/<?php echo $pick->path;?>"> <a href="#"><?php  echo Auth::user()->name;?></a>
