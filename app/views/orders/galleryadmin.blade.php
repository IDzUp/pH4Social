      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> <span class="glyphicon glyphicon-user"></span> Gallery </li>
          </ol>
          <div class="pull-right">

          {{ Form:: open(array('url' => 'searchgallery' , 'method' => 'get','class' => 'navbar-form navbar-left')) }} <!--contact_request is a router from Route class-->
  @if($errors->any())
  ...
  <button type="submit" style="float:right" class="register_btn">Search</button>
      ...
      <div class="row">
        ...
        <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Gallery</h3>
            </div>
    ...
    @foreach( $users as $hello)
                <tr>
                    ...
                    <td >
                        ...
                        <a target="_blank" href="{{ asset('/index.php') }}/gallery/{{$hello->uname}}" >SHOW GALLERY</a>
