...
<img src="{{ asset('/') }}public/{{$hello->cover}}" width="1170" height="334" alt=""  class="img-rounded"/>
...
@foreach( $profile as $hello)
<img src="{{ asset('/') }}public/{{$hello->path}}" alt="" class="img-circle" width="170" height="170"/>
...
<img src="{{ asset('/') }}public/{{$hellos->path}}"  style="max-width:100%;"/>
</div>
</div>
<?php
}
...
<span id=""></span>
<img style="float:left;" class="img-circle" alt="" width="30" height="30" src="{{ asset('/') }}public/<?php echo $hello['profilephoto']; ?>">
...
<li id="online<?php echo $hello['idd']; ?>">
<span id=""></span>
           <img style="float:left;" class="img-circle" alt="" src="{{ asset('/') }}public/<?php echo $hello['profilephoto']; ?>" width="30" height="30">
