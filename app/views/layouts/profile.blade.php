  ...
  function imageIsLoaded(e) {
    ...
    $('#previewing').attr('height', '230px');
        ...
        <div class="message_box" id="post{{$hello->id}}">
          ...
          <div class="u-nformation"><img  alt="iamge" class="img-circle img_wid" src="{{ asset('') }}/<?php if($pick){ echo $pick->path; } else{ if(Auth::user()->sex=='male'){ echo 'imagesfb/male.jpg'; } else{ echo 'imagesfb/female.jpg'; } } ?>"> <a href="#"><?php  echo Auth::user()->name;?></a>
      ...
      <?php
       ...
       @endforeach
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 padding2">
            <a href="{{ asset('/index.php') }}/allevent/{{Auth::user()->id;}}" class="all_btn" type="submit">View All</a>
          </div>
          <div class="clear"></div>
        </div>
      </div>
