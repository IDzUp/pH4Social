    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div class="left_box">
          ...
          <a href="#"><img src="../imagesfb/app_storebtn.png" alt="" /></a> <a href="#"><img src="../imagesfb/google_playbtn.png" alt="" /></a> <a href="#"><img src="../imagesfb/window_storebtn.png" alt="" /></a> </div>
      </div>
...
@if ($errors->has('email')) '<div class="alert alert-danger" role="alert">You Already have an Account</div>@endif
@if ($errors->has('password')) '<div class="alert alert-danger" role="alert">Password Required</div>@endif
@if ($errors->has('name')) '<div class="alert alert-danger" role="alert">Username Required</div>@endif
@if ($errors->has('city')) '<div class="alert alert-danger" role="alert">City Required</div>@endif
...
@endif
            ...
            <div class="form-group">
              <input type="City" name="city" required="" class="form-control input_height" id="" placeholder="City">
            </div>
          ...
          <div class="conversation_box2">
              ...
              <div class="safety">
                ...
                <div class="links">
                  ...
                  <li><a href="{{ asset('/index.php/') }}/page/{{$hello->id}}">{{$hello->title}}</a></li>
