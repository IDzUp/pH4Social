  ...
  <div class="container header_wid">
    <div class="row">
      <div id="logos" class="col-lg-3 col-md-3 col-sm-3 col-xs-12" >
        <div class="logo_member"><a href="{{ asset('/index.php/profile') }}"><img width="250" height="50" src="{{ asset('/') }}public/<?php echo $logo->path; ?>" alt="" /></a> </div>
...
<input type="text" class="search" id="searchid" name="search" autocomplete="off" placeholder="Search for people" />
</form>
<div id="result" class="wrapper"></div>
  ...
  <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
    <div class="top_nav pull-right">
      <ul>
       <li>          <a href="#" class="" data-toggle="modal" data-target=".bs-example-modal-sm"><span class="glyphicon glyphicon-search"></span>
     <span class="notifation"><p id=""></p></span><span class="hidden-sm hidden-xs">Advance</span></a></li>


     <li><a href="{{ asset('/index.php') }}/allfriendrequest"><span class="glyphicon glyphicon-user"></span>
     <span class="notifation"><p id="friendrequest"></p></span><span class="hidden-sm hidden-xs">{{trans ('greeting.Friend Request')}}</span></a></li>

    <li><a href="{{ asset('/index.php') }}/notifications"><span class="glyphicon glyphicon-globe"></span>
     <span class="notifation"><p id="notilike"></p></span> <span class="hidden-sm hidden-xs"> {{trans ('greeting.Notifications')}}</span></a></li>
     <li><a href="{{ asset('/index.php') }}/inbox"><span class="glyphicon glyphicon-envelope"></span>
       <span class="notifation"><p class="messnotification"></p></span><span class="hidden-sm hidden-xs">{{trans ('greeting.Inbox')}}</span> </a></li>
     <li class="dropdown">
    ...
    <ul class="dropdown-menu">
      <li><a href="{{ asset('/index.php') }}/profiledetails"><span class="glyphicon glyphicon-user"></span> </i>{{trans ('greeting.Profile')}}</a></li>
      <li><a href="{{ asset('/index.php') }}/fbsetting"><span class="glyphicon glyphicon-cog"></span> {{trans ('greeting.Settings')}}</a></li>
      <li><a href="{{ asset('/index.php') }}/inbox"><span class="glyphicon glyphicon-envelope"></span> {{trans ('greeting.Messages')}}</a></li>
      <li><a href="{{ asset('/index.php') }}/logoutsfb"><span class="glyphicon glyphicon-lock"></span> </i> {{trans ('greeting.Logout')}}</a></li>
    </ul>
    </li>
    </ul>
      </div>
        ...
        <div class="social-icons">
          <ul>
            ...
            <li class="googleplus"><a href="">Google +r</a></li>
                ...
                <button class="language" data-toggle="modal" data-target=".bs-example-modal-lgs">{{trans ('greeting.Select Your Language')}}</button>
<div class="modal fade bs-example-modal-lgs" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
@endif
  ...
  <div class="form-advance-search">
    ...
    <div class="form-group hair-color">
      <select name="hairColor"><option value="null">Hair Color</option>
