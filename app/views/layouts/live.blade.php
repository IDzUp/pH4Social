...
@include('live.header')
  ...
  <div class="footer">
    ...
    <div class="right_footer"> <a href="{{URL::to('site');}}">home</a> <a href="{{URL::to('site');}}">about</a> <a href="http://www.free-css.com/">sitemap</a> <a href="{{URL::to('site');}}">rss</a> <a href="{{URL::to('site');}}">contact us</a> </div>
  </div>
</div>
