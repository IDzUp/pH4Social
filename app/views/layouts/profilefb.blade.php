      ...
      <li><a href=""><span class="glyphicon glyphicon-bell"></span>
       ...
       <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="logoutsfb"><span class="glyphicon glyphicon-lock"></span> </i> Logout</a></li>
        </ul>
        </li>
      </ul>
      </div>
...
@endif
    {{ Form::token() }}
                ...
                <input id="image" name="image" placeholder="Image" required="" tabindex="1" type="file" onchange="document.getElementById('submits').click();">
...
@endforeach
            ...
            <ul>
              <li>
         <a class="current" href="#"> <span class="glyphicon glyphicon-camera"></span> Upload Photo(s)</a>
...
@endif
    {{ Form::token() }}
                ...
                <input id="image" name="image" placeholder="Image" required="" tabindex="1" type="file" onchange="document.getElementById('submit').click();">
                <input id="rand" name="rand" type="hidden" value="<?php echo $email = Auth::user()->rand;?>">
      ...
      {{ Form:: close() }}
              ...
              <li><a href="#"><span class="glyphicon glyphicon-calendar"></span> Create New Event</a></li>
      ...
      <div class="col-lg-7 col-md-6 col-sm-9">
        <div class="border">
          ...
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li> <a href="#messages" role="tab" data-toggle="tab"> <span class="glyphicon glyphicon-camera"></span> </a> </li>
          </ul>
