  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-4 col-xs-12">
        <div class="logo"> <a href="{{ asset('/index.php') }}/home"><img src="{{ asset('/') }}<?php echo $logo->path; ?>" alt="" /></a>
...
<!--           <a href="profile" class="sign">View Profile</a> -->
          <a href="{{ asset('/index.php') }}/profile" class="sign"> <span class="glyphicon glyphicon-user"></span> {{trans ('greeting.Profile')}}</a>
          <a href="{{ asset('/index.php') }}/logoutsfb" class="sign"> <span class="glyphicon glyphicon-off"></span> {{trans ('greeting.Logout')}}</a>
...
?>
        ...
        <div class="sign_box">
          ...
          <a href="#" class="sign" data-toggle="modal" data-target=".bs-example-modal-sm">{{trans ('greeting.Sign In')}}</a>
  ...
  {{ Form::token() }}
          ...
          <div class="form-group">
              ...
              <input type="email" class="form-control input-lg" required="" placeholder="Email Address" name="email"/>
               ...
               <div class="form-group">
               <input type="password" class="form-control input-lg" required="" placeholder="Password" name="password"/>
               </div>
        ...
        <div class="form-group">
         ...
         <span class="keep_text"> Keep me logged in </span>
          ...
          <br>
         &nbsp;&nbsp;&nbsp; <a href="#" data-toggle="modal" data-target=".bs-example-modal-sms" id="forgets" class="">{{trans ('greeting.Forget Password')}}</a>
...
<div class="modal fade bs-example-modal-sms" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
