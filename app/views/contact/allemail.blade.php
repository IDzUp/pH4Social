...
<!--                         {{ HTML::link('/contact/delete/' . $hello->id, '',array('class="glyphicon glyphicon-remove"')) }} -->
                <a href="{{ asset('/index.php') }}/mail/open/<?php echo $hello->id ?>" class="glyphicon glyphicon-eye-open"></a>
                <a href="{{ asset('/index.php') }}/mail/delete/<?php echo $hello->id ?>"  onclick="return confirm('Are you sure you want to delete?')" class="glyphicon glyphicon-remove"></a>
