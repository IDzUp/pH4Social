...
@endif
     ...
     <div class="form-group">
      ...
      <label for="email">Use link variable like < LINK ></label>
               ...
               <label for="Subject">Subject</label>
                <input id="subject" name="subject" value="<?php echo $confirmmail->subject; ?>" placeholder="Subject" required="" tabindex="2" type="text" class="form-control">
                 </div>
    ...
    <input id="email" name="from" value="<?php echo $confirmmail->from; ?>" placeholder="example@domain.com" required="" tabindex="2" type="email" class="form-control">
    </div>
...
tinymce.init({
    ...
    templates: [
        ...
        {title: 'Test template 2', content: 'Test 2'}
                ...
                <textarea name="comment" id="comment" tabindex="4" class="form-control"><?php echo $confirmmail->comment; ?></textarea>
                </div>
