        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-dashboard"></i> <a href="{{ asset('/index.php') }}/notitemplate">Notification
                            Template</a></li>
                ...
                {{ Form:: open(array('url' => 'emails/send' , 'method' => 'get','id' => 'contactform')) }} <!--contact_request is a router from Route class-->
                    ...
                    <div class="resgister_box">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" name="from" placeholder="example@domain.com" required="" tabindex="2"
                                   type="email" class="form-control">
                        </div>
