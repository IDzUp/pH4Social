...
<a href="{{ asset('/index.php') }}/contact/edit/<?php echo $hello->id ?>" class="">view</a>
...
<!--                         {{ HTML::link('/contact/delete/' . $hello->id, '',array('class="glyphicon glyphicon-remove"')) }} -->
                <a href="{{ asset('/index.php') }}/contact/delete/<?php echo $hello->id ?>"  onclick="return confirm('Are you sure you want to delete?')" class="glyphicon glyphicon-remove"></a>
