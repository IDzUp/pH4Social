        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-dashboard"></i> <a href="{{ asset('/index.php') }}/confirmmail">Confirmation
                            Email</a></li>
                ...
                {{ Form:: open(array('url' => 'contemplate/send' , 'method' => 'get','id' => 'contactform')) }} <!--contact_request is a router from Route class-->
                    ...
                    <div class="resgister_box">
                        ...
                        <div class="form-group">
                            ...
                            <input id="subject" name="subject" value="<?php echo $contemplate->subject; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" name="from" value="<?php echo $contemplate->from; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="comment" id="comment" tabindex="4"
                                      class="form-control"><?php echo $contemplate->comment; ?></textarea>
                        </div>
