            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Notification Email
                            Template</h3>
                    </div>
                ...
                {{ Form:: open(array('url' => 'notitemplate/send' , 'method' => 'get','id' => 'contactform')) }} <!--contact_request is a router from Route class-->
                    ...
                    <div class="resgister_box">
                        ...
                        <div class="form-group">
                            ...
                            <input id="subject" name="subject" value="<?php echo $notitemplate->subject; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" name="from" value="<?php echo $notitemplate->from; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="comment" id="comment" tabindex="4"
                                      class="form-control"><?php echo $notitemplate->comment; ?></textarea>
                        </div>
