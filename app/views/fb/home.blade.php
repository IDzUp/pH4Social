...
@endif
          ...
          <a href="#"><img src="{{ asset('/') }}public/imagesfb/app_storebtn.png" alt="" /></a> <a href="#"><img src="{{ asset('/') }}public/imagesfb/google_playbtn.png" alt="" /></a> <a href="#"><img src="{{ asset('/') }}public/imagesfb/window_storebtn.png" alt="" /></a> </div>
      </div>
...
@if ($errors->has('email')) <div class="alert alert-danger" role="alert"><?php if($errors->first('email')=='validation.required') { echo 'Email Required';} elseif($errors->first('email')=='validation.unique') { echo 'You Already have an Account'; } else { echo 'Email Not Valid'; } ?> </div>@endif
@if ($errors->has('password')) <div class="alert alert-danger" role="alert">Password Required</div>@endif
@if ($errors->has('name')) <div class="alert alert-danger" role="alert"><?php $name=implode('', $errors->all(':message')); if($name=='validation.max.string'){ echo 'Username Maximum length 25'; } else { echo 'Username Required or Unique'; } ?></div>@endif
@if ($errors->has('city')) <div class="alert alert-danger" role="alert"><?php $city=implode('', $errors->all(':message')); if($city=='validation.max.string'){ echo 'City Maximum length 25'; } else { echo 'City Required'; } ?></div>@endif
@if ($errors->has('location')) <div class="alert alert-danger" role="alert">Country Required</div>@endif
@if ($errors->has('agree')) <div class="alert alert-danger" role="alert">Checkbox Required</div>@endif
@endif
@endif
</div>
<style scoped>
...
.checkbox-inline.extracheckbox {
  width: 100%;
            ...
            <div class="form-group">
              <input type="email" name="email" required="" class="form-control input_height"  placeholder="Email">
            </div>
            <div class="form-group">
              <input type="Username" name="name" value="" required="" class="form-control input_height" id="emm" placeholder="Username">
            </div>
            <div class="form-group">
              <input type="password" name="password" required="" name="city" class="form-control input_height" id="emms" placeholder="Password">
            </div>
            <div class="form-group">
              <input type="text" name="city" required="" class="form-control input_height" id="" placeholder="City">
            </div>
  ...
  <option value="Zimbabwe">Zimbabwe</option>
            ...
            <div class="form-group"> {{trans ('greeting.Gender')}}
             ...
             <div class="form-group">
              <label class="checkbox-inline extracheckbox">
                ...
                By continuing, you're confirming that you've read and agree to the <a href="{{ asset('/index.php') }}/page/Terms & Condition">TOS</a> and <a href="{{ asset('/index.php') }}/page/Privacy">Privacy Policy</a> </label>
            ...
            <p class="sign-button"><button type="submit" class="sign_btn">{{trans ('greeting.Sign up')}}</button></p>
          </form>
        </div>
...
<section class="pepole_banner">
  <div class="container">
    <div class="row">
      ...
      <p>With hundreds of thousands of users you'll never run out of new people to chat with, new music to discover, or fun things to do</p>
    </div>
  </div>
</section>
<section class="conversation_sec">
  <div class="container">
    <div class="row">
      <h2><span class="glyphicon glyphicon-volume-up"></span> </span>Start a new conversation now... it's time to be social</h2>
    </div>
  </div>
  <div class="container">
          ...
          <div class="conversation_box2">
              ...
              <div class="safety">
                ...
                <div class="links">
                  ...
                  <li><a href="{{ asset('/index.php/') }}/page/{{$hello->title}}">{{$hello->title}}</a></li>
