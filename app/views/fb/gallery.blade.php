...
@endif
    {{ Form::token() }}
      ...
      Upload Photo
       <input id="coverimage" name="image" required="" tabindex="1" type="file" onchange="displayPreview();">
      </label>
...
@endif
    {{ Form::token() }}
      ...
      <label id="" class="search_btn">
            Upload Video
       <input id="coverimages" name="image" required="" tabindex="1" type="file" onchange="displayPreviews();">
      </label>
...
?>
    ...
    <div class="col-sm-6 col-xs-6 col-md-3 small-full" id="gal{{$hello->id}}">
      ...
      <button id="{{$hello->id}}" class="gallerydelete"><span class="glyphicon glyphicon-remove"></span></button>
     <div class="clfancy{{$hello->id}}" style="display:none; float:right;  z-index:99999999999;"><a style="cursor:pointer;" name="fancy{{$hello->id}}" class="clxs"><span class="glyphicon glyphicon-remove"></span></a></div>
...
<embed src="{{$hello->imagessvideo}}" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="100%" height="auto">
...
<video width="100%" height="auto" controls>
  ...
  <source src="{{ asset('/') }}{{$hello->imagessvideo}}" type="video/webm">
