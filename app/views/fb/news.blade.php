                ...
                <div class="row">
                    <div class="cover" style="width:1170px; height:334px;">
                        ...
                        @foreach( $profile as $hello)
                            ...
                            <img src="{{ asset('/') }}{{$hello->cover}}" width="1170" height="334" alt=""
                                 class="img-rounded"/>
                            ...
                            <div class="bg_nav">
                                <div class="nav">
                                    <div class="userphoto">
                                        ...
                                        @foreach( $profile as $hello)
                                            <img src="{{ asset('/') }}{{$hello->path}}" alt="" class="img-circle"
                                    ...
                                    <ul>
                                        ...
                                        {{ Form:: open(array('url' => 'fbmedia/save' , 'method' => 'post','name' => 'my_form','id' => 'my_form','files' => 'true', 'enctype' => 'multipart/form-data')) }} <!--contact_request is a router from Route class-->
                                            ...
                                            <label id="coverimage">
                                                ...
                                                <input id="coverimagek" name="image" required="" tabindex="1"
                                                       type="file"
                                        ...
                                        <li class="{{ Request::is( 'news') ? 'activess' : '' }}"><a
                                                    href="{{ asset('/index.php/') }}/news"><span
                                            ...
                                            <div class="comment_box likebox"><span
                                                ...
                                                <div class="like">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <span id="countlike{{$hello['id']}}">{{$hello['like']}}</span>
                                                        </li>
                                                        <li><span>
                      ...
                      name="{{$hello['id']}}"></a>
                                        ...
                                        <div id="rleft{{$hello['id']}}">
                                            <div class="cl{{$hello['id']}}" style="display:none; float:right;"><a
                                                        style="cursor:pointer;" name="{{$hello['id']}}"
                                                        class="clx"><span class="glyphicon glyphicon-remove"></span></a>
                                            </div>
...
<embed src="{{ asset('/') }}{{$hellos->imagessvideo}}" style="max-width:100%;">
                                            ...
                                            <div class="comment_box comment_boxs">
                                                <form onsubmit="return comm({{$hello['id']}},this)"
                                                      name="comments{{$hello['id']}}" data-value="{{$hello['id']}}"
                                                      class="com" id="uni{{$hello['id']}}" method="post"
                                    ...
                                    <div id="fleft{{$hello['id']}}">
                                        ...
                                        <div class="comment_box likebox"><span
                                            ...
                                            <div class="like">
                                                <ul>
                                                    <li><span class="glyphicon glyphicon-comment"></span></li>
                                                    <li><span id="countlike{{$hello['id']}}">{{$hello['like']}}</span>
                                                    </li>
                                                    <li><span>
                   <a style="cursor:pointer;" class="likes glyphicon glyphicon-thumbs-down" id="a{{$hello['id']}}"
                      name="{{$hello['id']}}"></a>
...
<embed src="{{ asset('/') }}{{$hellos->imagessvideo}}" width="200" height="200">
                                                    ...
                                                    <video style="width:100%;" controls>
                                                        <source src="{{ asset('/') }}{{$hellos->imagessvideo}}"
                                                                type="video/mp4">
                                                        <source src="{{ asset('/') }}{{$hellos->imagessvideo}}"
                                                                type="video/ogg">
                                        ...
                                        <div class="comment_box comment_boxs">
                                            <form onsubmit="return comm({{$hello['id']}},this)"
                                                ...
                                                <label id="imagessvideos{{$hello['id']}}" style="cursor:pointer;"
                                                       class="vdo"><input onchange="video({{$hello['id']}});"
                                                                          class="vdos" id="imagessvideo{{$hello['id']}}"
                                                                          name="imagessvideo" type="file"></label>


                                                <button value="{{$hello['id']}}" id="submitbtn{{$hello['id']}}"
                                                        type="submit"
                                                        class="buttonss{{$hello['id']}} btn send_btn pull-right coms">{{trans ('greeting.Send')}}</button>
                                            </form>
                                        </div>
                            ...
                            {{ Form:: open(array('url' => 'createevent' , 'method' => 'get','id' => 'contactformr','files' => 'true', 'enctype' => 'multipart/form-data')) }} <!--contact_request is a router from Route class-->
                                ...
                                <div class="form-group padding">
                                    ...
                                    <div class="input-group padding">
                                        <input type="text" required pattern=".*\S+.*" placeholder="Event Name"
                                               name="event" class="form-control">
                                        <span class="input-group-addon glyphicon glyphicon-pencil"></span></div>
                                    <div class="input-group padding">
                                        <input type="text" required pattern=".*\S+.*" placeholder="Location"
                                    ...
                                    <div class="padding">
                                        <button class="all_btn"
                                                type="submit">{{trans ('greeting.Create Event')}}</button>
                                    </div>
                            ...
                            @foreach( $events as $hellos)
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 padding2 border-bottom">
                                    ...
                                    <div class="pull-left add-frnd"><a>{{$hellos->event}}</a><br/>
                                        <span>{{$hellos->dates}}
                                            -{{$hellos->timess}} <!-- - <a href="#">Hide</a></span>  --></div>
                                </div>
        ...
        <div id="chatmessenger" style="z-index:214748364;">
            <div id="chatmessengers">
                ...
                <h3 id="clickchat"><span class="glyphicon glyphicon-user"></span> {{trans ('greeting.Chat Messenger')}}
                </h3>
                    ...
                    @foreach( $outputs as $hello)
                        ...
                        <li id="online<?php echo $hello['idd']; ?>">
                            ...
                            <p class="openbox" id="<?php echo $hello['idd']; ?>"
                               style="float:left; cursor:pointer; margin-left:15px;"><?php echo $hello['name']; ?></p>
