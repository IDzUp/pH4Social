 ...
 <div class="col-sm-6 col-md-4">
         <div class="thumbnail center_box">
          <div class="friend_list_img">
           <img class="img-circle" alt="" width="170" height="170" src="{{ asset('/') }}<?php echo $hello['profilephoto']; ?>">
            </div>
            <div class="caption">
            ...
            <span class="glyphicon glyphicon-map-marker"></span>
             <span> <?php echo $hello['city']; ?>,<?php echo $hello['location']; ?> </span>
            </div>
                 <a href="{{ asset('/index.php/') }}/profileopen/<?php echo $hello['uname']; ?>">
            <button type="button" class="like_btn btn-lg mar_top">
            <span class="glyphicon glyphicon-eye-open"></span> View Profile</button></a>
          </div>
        </div>
      </div>
...
@foreach( $outputss as $hello)
 ...
 <div class="col-sm-6 col-md-4">
         <div class="thumbnail center_box">
          <div class="friend_list_img">
           <img class="img-circle" alt="" src="{{ asset('/') }}/<?php echo $hello['profilephoto']; ?>" width="170" height="170">
            </div>
            <div class="caption">
            <h3><?php echo $hello['name']; ?></h3>
                    <div class="friendlistadd">
            <span class="glyphicon glyphicon-map-marker"></span>
             <span>  <?php echo $hello['city']; ?>, <?php echo $hello['location']; ?></span></div>
             <a href="{{ asset('/index.php/') }}/profileopen/<?php echo $hello['uname']; ?>">
            <button type="button" class="like_btn btn-lg mar_top">
            <span class="glyphicon glyphicon-eye-open"></span> View Profile</button></a>
          </div>
