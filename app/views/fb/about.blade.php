...
<section class="profile_sec">
  <div class="container">
    ...
    <div class="col-sm-4 col-md-3 col-xs-12">
     ...
     <img alt="" src="<?php if($profile) { ?>{{ asset('/') }}/<?php echo $profile->path; ?> <?php } elseif(Auth::user()->sex=='male'){ ?> {{ asset('/') }}imagesfb/male.jpg <?php } else {  ?> {{ asset('/') }}imagesfb/female.jpg <?php   }     ?>" width="170" height="170">
     </div>
    </div>
          <div class="caption">
