...
<img src="{{ asset('/') }}<?php if($proinfo){ echo $proinfo->cover;} elseif($userinfo->sex=='male'){ echo 'imagesfb/male_cover.jpg';}else { echo 'imagesfb/female_cover.jpg';} ?>" width="1170" height="334" alt=""  class="img-rounded"/>
...
<a id="remo" class="<?php echo $uname;?>" style="color:#333; <?php if(!$proinfo){ echo 'pointer-events:none';} ?><?php if($proinfo){ if($proinfo->cover=='imagesfb/male_cover.jpg' || $proinfo->cover=='imagesfb/female_cover.jpg' ) { echo 'pointer-events:none';} }?>">
    ...
    <div class="row">
      <div class="col-lg-2 col-md-3 col-sm-3">
        ...
        <?php
            if(Auth::user()->username=='admin')
    {?>
   <a id="remos" style="padding:0px; border-bottom:none; <?php if(!$proinfo){ echo 'pointer-events:none';} ?><?php if($proinfo){ if($proinfo->path=='imagesfb/male.jpg' || $proinfo->path=='imagesfb/female.jpg' ) { echo 'pointer-events:none';} }?>"  class="<?php echo $uname; ?>">
...
<img src="{{ asset('/') }}<?php if($proinfo){ echo $proinfo->path;} elseif($userinfo->sex=='male'){ echo 'imagesfb/male.jpg';}else { echo 'imagesfb/female.jpg';} ?>" alt="" class="img-circle" width="170" height="170"/>
...
?>
              ...
              <li><a href="{{ asset('/index.php') }}/messages/<?php echo $userinfo->uname; ?>"><span class="glyphicon glyphicon-tasks"></span> {{trans ('greeting.Messages')}}</a> </li>
        ...
        ?>
              ...
              <li><a href="{{ asset('/index.php/') }}/gallery/<?php echo $userinfo->uname; ?>"><span class="glyphicon glyphicon-calendar"></span> {{trans ('greeting.Gallery')}}</a></li>
              <li><a href="{{ asset('/index.php/') }}/about/<?php echo $userinfo->uname; ?>"><span class="glyphicon glyphicon-calendar"></span>About</a></li>
   ...
   <li><a href="{{ asset('/index.php/') }}/unblock/<?php echo $userinfo->uname; ?>"><span class="glyphicon glyphicon-calendar"></span> UnBlock</a></li>
                <?php
              ...
              else
              {
                ...
                <li><a href="{{ asset('/index.php/') }}/block/<?php echo $userinfo->uname; ?>"><span class="glyphicon glyphicon-calendar"></span> Block</a></li>
            <?php
              }
              ?>
...
<label style="cursor:pointer;" id="imagess{{$hello['id']}}" class="imgg{{$hello['id']}}"><input onchange="image({{$hello['id']}});" class="imggs" id="imagesss{{$hello['id']}}" name="imagesss"  type="file"></label>


<label style="cursor:pointer;" id="imagessvideos{{$hello['id']}}" class="vdo{{$hello['id']}}"><input onchange="video({{$hello['id']}});" class="vdos" id="imagessvideo{{$hello['id']}}" name="imagessvideo"  type="file"></label>
