                      ...
                      <div class="notif_list">
                         <ul class="event_list">
                            <li>
                                 ...
                                 {
?>
<a href="{{ asset('/index.php/') }}/eventsdelete/{{$hello->id}}" class="pull-right all glyphicon glyphicon-remove"></a>
<?php
                                 }
                                 ?>
    ...
    {{ Form::token() }}
            ...
            <div class="form-group padding">
              ...
              <div class="input-group padding">
                <input type="text" required pattern=".*\S+.*" placeholder="Event Name" id="events" name="event" class="form-control">
...
?>
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding2">
                        <a type="submit" class="all_btn" href="{{ asset('/index.php') }}/allevent/{{Auth::user()->uname;}}">View All</a>
                      </div>
                      <div class="clear"></div>
                </div>
              </div>
