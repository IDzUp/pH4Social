...
<img src="{{ asset('/') }}<?php  echo $hellos['profilephoto']; ?>" width="63" height="78"/>
...
@foreach( $search as $hello)
            ...
            <a href="{{ asset('/index.php') }}/profileopen/{{$hello->uname}}">
              ...
              <span class="glyphicon glyphicon-eye-open"></span> View Profile</button>
              </a>
              <h4>{{$hello->name}}</h4>
              <span class="glyphicon glyphicon-map-marker"></span> {{$hello->city}}, {{$hello->location}}
