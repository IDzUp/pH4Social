...
@section('content')
    ...
    <div class="grid_9">
        <h1 class="content">Sub Category Pages</h1>
    </div>
    <!--RIGHT TEXT/CALENDAR-->
    ...
    <div id="portlets">
        ...
        {{ Form:: open(array('url' => 'category/subcategorysave' , 'method' => 'get','id' => 'contactform')) }} <!--contact_request is a router from Route class-->
