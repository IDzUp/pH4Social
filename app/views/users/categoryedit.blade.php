...
@section('content')
    ...
    <div id="portlets">
        ...
        {{ Form:: open(array('url' => 'updatecategory' , 'method' => 'put')) }} <!--contact_request is a router from Route class-->
            @if($errors->any())
            ...
            <div id="center">
                ...
                <p class="float">
                    ...
                    {{ Form::hidden('id',$categoryedit->id)}}
                </p>
                <p class="float">

                    {{ Form:: label ('name', 'Name*' )}}
                    {{ Form:: text ('name',    $categoryedit->title  )}}
                </p>

                <p class="float">

                    {{ Form:: label ('message', 'Message Box' )}}
                    {{ Form:: textarea ('message',    $categoryedit->content  )}}
                </p>
