...
@section('content')
    ...
    <div id="portlets">
        ...
        {{ Form:: open(array('url' => 'eventadd/save' , 'method' => 'post','id' => 'contactform','files' => 'true', 'enctype' => 'multipart/form-data')) }} <!--contact_request is a router from Route class-->
            @if($errors->any())
