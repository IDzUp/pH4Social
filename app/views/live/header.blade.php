          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                ...
                <li><a href="#"><i class="fa fa-envelope"></i> <?php if(Auth::user()) { echo ' ';   } ?><?php if(Auth::user()){ echo $email = Auth::user()->email;}?></a></li>
...
?><span class="price">
                ...
                <!--<li><a href="login.html"><i class="fa fa-lock"></i> Login</a></li>-->
                  ...
                  <li><a  href="{{ URL::asset('') }}index.php/<?php if(Auth::user()){ echo 'logouts';} else{echo 'signup';}?>"><?php if(Auth::user()){ echo '<i class="fa fa-lock"></i> '.'Logout';} else{echo '<i class="fa fa-lock"></i> '.'Sign Up';}?></a></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                  ...
                  <li><a  href="{{ URL::asset('') }}index.php/<?php if(Auth::user()){ echo 'logouts';} else{echo 'signup';}?>"><?php if(Auth::user()){ echo 'Logout';} else{echo 'Sign Up';}?></a></li>
