...
?>
  ...
  <tr>
    ...
    <p{{$s}}>
        <img src="http://i.imgur.com/yOadS1c.png" id="minus1{{$s}}" width="20" height="20" class="minus{{$s}}"/>
        <input id="qty1{{$s}}" type="text" value="1" class="qty{{$s}}"/>
        <img id="add1{{$s}}" src="http://i.imgur.com/98cvZnj.png" width="20" height="20" class="add{{$s}}"/>
    </p>
              ...
              <td class="cart_delete">
                <a class="cart_quantity_delete" href="shopping/delete/{{$hello->id}}"><i class="fa fa-times"></i></a>
              </td>
            </tr>
